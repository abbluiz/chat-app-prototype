...
io.on('connection', (socket) => {
    ...
    socket.on('sendLocation', (receivedLocation, callback) => {
        
        const user = getUser(socket.id);

        io.to(user.room).emit('locationMessage', generateLocationMessage(user.username, `https://google.com/maps?q=${receivedLocation.latitude},${receivedLocation.longitude}.`));
        callback();
